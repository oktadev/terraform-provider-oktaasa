...
func resourceASAAssignGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceASAAssignGroupCreate,
		Read:   resourceASAAssignGroupRead,
		Update: resourceASAAssignGroupUpdate,
		Delete: resourceASAAssignGroupDelete,
...
func resourceASAAssignGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	return resourceASAAssignGroupRead(d, m)
}
...
func resourceASAAssignGroupRead(d *schema.ResourceData, m interface{}) error {
...
func resourceASAAssignGroupUpdate(d *schema.ResourceData, m interface{}) error {
	return resourceASAAssignGroupCreate(d, m)
}

func resourceASAAssignGroupDelete(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
