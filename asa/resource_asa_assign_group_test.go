		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccProjectCheckExists3("asa_project.test", project),
					resource.TestCheckResourceAttr(
						"asa_project.test", "project_name", projectName,
					),
					resource.TestCheckResourceAttr(
						"asa_project.test", "next_unix_uid", "60120",
					),
					resource.TestCheckResourceAttr(
						"asa_project.test", "next_unix_gid", "63020",
					),
					resource.TestCheckResourceAttr(
						"asa_create_group.test-group", "name", groupName,
					),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "project_name", projectName,
					),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "group_name", groupName,
					),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "server_access", "true",
					),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "server_admin", "true",
					),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "create_server_group", "true",
					),
				),
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccGroupAssignCheckExists("asa_assign_group.test-acc-group-assignment", groupassign),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "project_name", projectName,
					),
					resource.TestCheckResourceAttr(
					...
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "server_admin", "false",
					),
					resource.TestCheckResourceAttr(
						"asa_assign_group.test-acc-group-assignment", "create_server_group", "true",
					),
...
resource "asa_project" "test" {
    project_name = "test-acc-project_g"
  	next_unix_uid = 60120
  	next_unix_gid = 63020
}

resource "asa_create_group" "test-group" {
    name = "test-acc-group_g"
}

resource "asa_assign_group" "test-acc-group-assignment" {
    project_name = asa_project.test.project_name
  	group_name = asa_create_group.test-group.name
	server_access = true
	server_admin = true
