...
func resourceASAToken() *schema.Resource {
	return &schema.Resource{
		Create: resourceASATokenCreate,
		Read:   resourceASATokenRead,
		Update: resourceASATokenUpdate,
		Delete: resourceASATokenDelete,
...
func resourceASATokenCreate(d *schema.ResourceData, m interface{}) error {
	...
	return resourceASATokenRead(d, m)
}

func resourceASATokenRead(d *schema.ResourceData, m interface{}) error {
...
func resourceASATokenUpdate(d *schema.ResourceData, m interface{}) error {
	// not possible to update token.
	return nil
}

func resourceASATokenDelete(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
